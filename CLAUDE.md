...
- [2026-03-23] Added GitHub Repository Secrets section to `PROJECT-GUIDE.md` — documents all 13 secrets (6 backend: FIREBASE_SERVICE_ACCOUNT, GEMINI_API_KEY ×5; 7 frontend: VITE_FIREBASE_* ×6 + VITE_FIREBASE_VAPID_KEY). Secrets are injected via CI/CD, no local `.env` needed.
